    ...
    <form method="post" id="knawatds_setting_form">
        <table class="form-table">
            ...
            <tr class="knawat_dropshipwc_row">
                ...
                <td>
                    <input class="mp_consumer_key regular-text" name="knawat[mp_consumer_key]" type="text" value="<?php if ( $mp_consumer_key != '' ) {
            ...
            <tr class="knawat_dropshipwc_row">
                ...
                <td>
                    <input class="mp_consumer_secret regular-text" name="knawat[mp_consumer_secret]" type="text" value="<?php if ( $mp_consumer_secret != '' ) {
