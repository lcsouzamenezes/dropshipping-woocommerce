...
$knawat_setup = new Knawat_Merlin(
	...
	$strings = array(
		...
		'title%s%s%s'              => esc_html__( '%1$s%2$s Knawat &lsaquo; Knawat Setup %3$s', 'dropshipping-woocommerce' ),
		...
		'ready-link-1'             => wp_kses(
			sprintf( __( '<a href="https://knawat.com/" target="_blank">%s</a>', 'dropshipping-woocommerce' ), 'Explore Knawat' ),
			array(
				'a' => array(
					'href'   => array(),
					'target' => array(),
		...
		'ready-link-3'             => wp_kses(
			sprintf( __( '<a href="' . admin_url( 'customize.php' ) . '" target="_blank">%s</a>', 'dropshipping-woocommerce' ), 'Start Customizing' ),
			array(
				'a' => array(
					'href'   => array(),
					'target' => array(),
